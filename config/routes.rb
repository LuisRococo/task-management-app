...
Rails.application.routes.draw do
  ...
  post 'toggle-board-delete-emails', to: 'users#toggle_board_delete_emails'
  post 'toggle_board_update_emails', to: 'users#toggle_board_update_emails'
  post 'toggle_board_create_emails', to: 'users#toggle_board_create_emails'
  root 'pages#home'
